...
return [
    ...
    'Voice model instructions' => "Choose the voice model to use with Bespoken. ElevenLabs has multiple voice model options. <b>Eleven v3 (alpha)</b> is the latest model, but, as the name suggests, is in alpha but can be used. The default model for Bespoken is <b>Multilingual v2</b>. For more information read <a href='https://elevenlabs.io/docs/speech-synthesis/models'>ElevenLabs Models documentation</a> and the article, <a href='https://help.elevenlabs.io/hc/en-us/articles/17883183930129-What-models-do-you-offer-and-what-is-the-difference-between-them'><i>What models do you offer and what is the difference between them?</i></a>",
